...
function recent_pf($atts) {
 extract(shortcode_atts(array('limit'=>'4', 'fullpage' => 'no', 'orderby'=> 'date', 'filters' => ''), $atts));
...
add_shortcode('list', 'purelist');
    ...
    function pp_feature( $atts, $content ) {
        ...
        $output .= '<i class="'.$icon.'" style="margin-left: -10px;"></i>';
    ...
    function recent_blog($atts) {
     extract(shortcode_atts(array( 'number' => '3','fullpage' => 'no'), $atts));
   ...
   function pp_social_icon($atts) {
    ...
    $output = '<a href="'.$url.'" rel="tooltip" target="_blank" title="'.$title.'" class="'.$imagename.'">'.$service.'</a>';
    return $output;
}
...
function pp_team($atts, $content ) {
   ...
   if($twitter) $output .= ' <li class="twitter"><a href="'.$twitter.'" target="_blank">Twitter</a></li>';
   if($facebook) $output .= ' <li class="facebook"><a href="'.$facebook.'" target="_blank">Facebook</a></li>';
   if($linkedin) $output .= ' <li class="linkedin"><a href="'.$linkedin.'" target="_blank">LinkedIn</a></li>';
   if($vimeo) $output .= ' <li class="vimeo"><a href="'.$vimeo.'" target="_blank">Vimeo</a></li>';
   if($youtube) $output .= ' <li class="youtube"><a href="'.$youtube.'" target="_blank">Youtube</a></li>';
   if($skype) $output .= ' <li class="skype"><a href="'.$skype.'" target="_blank">Skype</a></li>';
